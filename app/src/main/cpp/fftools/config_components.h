...
#define CONFIG_AMRNB_MEDIACODEC_DECODER 1
#define CONFIG_AMRWB_MEDIACODEC_DECODER 1
...
#define CONFIG_MP3_MEDIACODEC_DECODER 1
...
#define CONFIG_ANDROID_CONTENT_PROTOCOL 1
